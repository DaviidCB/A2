...
/*Para definir datos reales se antepone la palabra reservada float al identificador de la variable. las que utilizare son DACB_x,DACB_s=0.0*/
float DACB_x,DACB_s=0.0;

/*El tipo int es el tipo entero básico predeterminado. Puede representar todos los números enteros en un intervalo específico de la implementación en este tipo de ejercicio utilizaremos DACB_i=0,DACB_l */
int DACB_i=0,DACB_l;

/*cout nos ayude imprimir por pantalla todos lo que vamos a escribir dentro de las comillas e ingresaremos *DACB_l:*/
cout<<"Ingrese el valor de DACB_l: ";        
...
cout<<"Ingrese el valor de DACB_x: ";
...
cout<<"La suma de los número fue: "<<DACB_s<<endl;                                
